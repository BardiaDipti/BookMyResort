...
if ($_POST) 
{
    ...
    $query = mysqli_query($connection, "Insert into payment_tbl(payment_mode, payment_date, payment_details, payment_status, cust_id, booking_id, order_no) values('{$mode}', '{$date}', '{$details}', '{$status}', '{$custid}', '{$bookingid}', '{$orderno}')") or die(mysqli_error($connection));
    ...
    $('#txtDate').attr('min', maxDate);
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    $q = mysqli_query($connection, "select * from booking_tbl") or die(mysqli_error($connection));
                                              
                                                    echo "<select name='bookingid' class='form-control' required>";
                                                    echo "<option selected disabled>Select Here</option>";
                                                    while($data = mysqli_fetch_array($q)){
                                                        echo "<option value='{$data['booking_id']}'>{$data['booking_details']}</option>";
                                                    }
                                                    echo "</select>";
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    $q = mysqli_query($connection, "select * from order_tbl") or die(mysqli_error($connection));
                                              
                                                    echo "<select name='orderno' class='form-control' required>";
                                                    echo "<option selected disabled>Select Here</option>";
                                                    while($data = mysqli_fetch_array($q)){
                                                        echo "<option value='{$data['order_no']}'>{$data['order_type']}</option>";
                                                    }
                                                    echo "</select>";
