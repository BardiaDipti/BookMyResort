...
if ($_POST) 
{
    ...
    $query = mysqli_query($connection, "Insert into feedback_tbl(feedback_date, feedback_details, ratings, cust_id) values('{$date}', '{$details}', '{$ratings}', '{$custid}')") or die(mysqli_error($connection));
...
<script>
    ...
    $('#txtDate').attr('min', maxDate);
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input required type="number" min='1' max='5'" class="form-control" name="ratings" placeholder="Provide ratings">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
