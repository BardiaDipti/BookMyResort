...
if ($_POST) 
{
    ...
    $query = mysqli_query($connection, "Insert into order_tbl(order_type, order_details, order_date, menu_id, cust_id) values('{$type}', '{$details}', '{$date}', '{$menuid}', '{$custid}')") or die(mysqli_error($connection));
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card">
                               ...
                               ?>
                                ...
                                <h4 class="card-title">Food Order Form</h4>
                           </div>-->
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form id="myform" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                <select class="form-control form-white" name="type" placeholder="Choose one" required>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input required type="text" class="form-control" name="details" placeholder="Enter details">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
    ...
    $('#txtDate').attr('min', maxDate);
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    $q = mysqli_query($connection, "select * from menu_tbl") or die(mysqli_error($connection));
                                              
                                                    echo "<select name='menuid' class='form-control' required>";
                                                    echo "<option selected disabled>Select Here</option>";
                                                    while($data = mysqli_fetch_array($q)){
                                                        echo "<option value='{$data['menu_id']}'>{$data['menu_item']}</option>";
                                                    }
                                                    echo "</select>";
