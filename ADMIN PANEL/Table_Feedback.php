...
<?php
    ...
    {
        $did = $_GET['did'];
        $deleteq = mysqli_query($connection,"Delete From feedback_tbl where feedback_id='{$did}'")or die(mysqli_error($connection));
    ...
    , `feedback_tbl`.`feedback_details`
    , `feedback_tbl`.`ratings`
    , `customer_tbl`.`cust_fname`
FROM
    `customer_tbl`
    INNER JOIN `feedback_tbl` 
        ON (`customer_tbl`.`cust_id` = `feedback_tbl`.`cust_id`);";
    ...
    while($row = mysqli_fetch_array($query))
    {
        ...
        echo "<td>
        <a href='Table_Feedback.php?did={$row['feedback_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }
    ...
    /*while($feedbackrow = mysqli_fetch_array($selectq))
    {
        ...
        echo "<td>{$feedbackrow['ratings']}</td>";
        echo "<td>{$feedbackrow['cust_id']}</td>";
        echo "<td>
        <a href='Table_Feedback.php?did={$feedbackrow['feedback_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }*/
?>
                                        </tbody>
