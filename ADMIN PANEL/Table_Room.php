...
<?php
    ...
    //$selectq = mysqli_query($connection, "Select * From room_tbl")or die(mysqli_error($connection));
    ...
    INNER JOIN `room_tbl` 
        ...
        while($row = mysqli_fetch_array($query))
        {
            ...
            echo "<td>
                ...
                <a href='Table_Room.php?did={$row['room_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
            echo "</tr>";
        }
        
    /*while($roomrow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
        echo "<td>{$roomrow['room_id']}</td>";
        echo "<td>{$roomrow['room_type']}</td>";
        echo "<td>{$roomrow['room_details']}</td>";
        echo "<td><img src='Room/{$roomrow['room_imagepath']}' width='150px;'/></td>";
        echo "<td>{$roomrow['room_price']}</td>";
        echo "<td>{$roomrow['category_id']}</td>";
        echo "<td>
        <a href='#' class='btn btn-primary shadow btn-xs sharp me-1'><i class='fas fa-pencil-alt'></i></a>
        <a href='Table_Room.php?did={$roomrow['room_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }*/    
?>
                                        </tbody>
