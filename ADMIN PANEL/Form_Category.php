...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "Insert into category_tbl(category_type) values('{$type}')") or die(mysqli_error($connection));
                                    ...
                                    <div class="basic-form">
                                        <form method="post" id="myform" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control form-white" name="type" name="txt1" required>
