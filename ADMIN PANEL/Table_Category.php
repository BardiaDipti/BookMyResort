...
<?php
    ...
    {
        $did = $_GET['did'];
        $deleteq = mysqli_query($connection,"Delete From category_tbl where category_id='{$did}'")or die(mysqli_error($connection));
    ...
    $selectq = mysqli_query($connection, "Select * From category_tbl")or die(mysqli_error($connection));

    while($categoryrow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
        echo "<td>{$categoryrow['category_id']}</td>";
        echo "<td>{$categoryrow['category_type']}</td>";
        echo "<td>
        <a href='#' class='btn btn-primary shadow btn-xs sharp me-1'><i class='fas fa-pencil-alt'></i></a>
        <a href='Table_Category.php?did={$categoryrow['category_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }
