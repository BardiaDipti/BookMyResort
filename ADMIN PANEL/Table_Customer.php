...
<?php
    ...
    {
        $did = $_GET['did'];
        $deleteq = mysqli_query($connection,"Delete From customer_tbl where cust_id='{$did}'")or die(mysqli_error($connection));
    ...
    $selectq = mysqli_query($connection, "Select * From customer_tbl")or die(mysqli_error($connection));

    while($customerrow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
        echo "<td>{$customerrow['cust_id']}</td>";
        echo "<td>{$customerrow['cust_password']}</td>";
        echo "<td>{$customerrow['cust_fname']}</td>";
        echo "<td>{$customerrow['cust_lname']}</td>";
        echo "<td>{$customerrow['contact_no']}</td>";
        echo "<td>{$customerrow['cust_email']}</td>";
        echo "<td>{$customerrow['cust_identity_type']}</td>";
        echo "<td>{$customerrow['cust_identity_no']}</td>";
        echo "<td>
        <a href='#' class='btn btn-primary shadow btn-xs sharp me-1'><i class='fas fa-pencil-alt'></i></a>
        <a href='Table_Customer.php?did={$customerrow['cust_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }
