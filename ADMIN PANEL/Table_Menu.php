...
<?php
    ...
    {
        $did = $_GET['did'];
        $deleteq = mysqli_query($connection,"Delete From menu_tbl where menu_id='{$did}'")or die(mysqli_error($connection));
    ...
    $selectq = mysqli_query($connection, "Select * From menu_tbl")or die(mysqli_error($connection));

    while($menurow = mysqli_fetch_array($selectq))
    {
        echo "<tr>";
        echo "<td>{$menurow['menu_id']}</td>";
        echo "<td>{$menurow['menu_item']}</td>";
        echo "<td>{$menurow['price']}</td>";
        echo "<td>
        <a href='#' class='btn btn-primary shadow btn-xs sharp me-1'><i class='fas fa-pencil-alt'></i></a>
        <a href='Table_Menu.php?did={$menurow['menu_id']}' class='btn btn-danger shadow btn-xs sharp'><i class='fa fa-trash'></i></a></td>";
        echo "</tr>";
    }
