...
if(isset($_POST["submit"]))
{
    ...
    $query_ins = mysqli_query($connection,"INSERT INTO `booking_tbl`(`booking_name`, `booking_details`, `booking_date`, `cust_id`, `category_id`, `event_id`, `f_name`, `l_name`, `book_amount`) VALUES ('{$booking_name}','{$booking_details}','{$book_datetime}','{$cust_id}','{$category_id}','{$event_id}','{$f_name}','{$l_name}','{$book_amount}')");
    if($query_ins)
    {
        echo "<script>alert('Your booking successfully added');window.location='event-booking-list.php';</script>";
    }
    exit();
}
if(isset($_GET["id"]))
...
$query_1 = mysqli_query($connection,"SELECT * FROM `event_tbl` WHERE `event_id`='{$id}'");
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 pull-left">
          <div class="book-left-content input_form">
              <form id="contactBooking" action="event-booking.php" method="post">
              <div class="row">
                  <input type="hidden" name="event_id" value="<?php echo $data_1["event_id"];?>">
                   <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                         <input id="name" type="text" name="booking_name" value="<?php echo $data_1["event_title"];?>"  placeholder="Enter Name" class="form-control" required readonly="">
                </div> 
                     <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                    <input id="name" type="text" name="book_amount" value="<?php echo $data_1["event_price"];?>"  placeholder="Enter Price" class="form-control" required readonly="">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
