...
$query_p = mysqli_query($connection,"SELECT * FROM `package_tbl` WHERE `package_id`='{$id}'");
...
<head>
 ...
 <body class="vh-100">
    ...
    <section class="row final-inner-header">
      <div class="container">
        <h2 class="this-title"><?php echo $data_p["package_title"];?></h2>
      </div>
    </section>
    <section class="row final-breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $data_p["package_title"];?></li>
        </ol>
      </div>
    </section>
    <!-- Header  Slider style-->
          ...
          <div class="single-sidebar-widget sroom-sidebar">
            ...
            <div class="book-r-form">
              <div class="room-price">
                <h6>starting from</h6>
                <p>₹<?php echo $data_p["package_price"];?></p>
              </div>
              <div class="book-form">
                <div class="col-md-12">
                    <!--<b>Arrival Date</b>-->
...
<!--                <div class="col-md-12"><b>Adults</b>
                ...
                <div class="col-md-12">
                  <div class="chk-button">
                    ...
                    <a href="package-booking.php?id=<?php echo $data_p["package_id"];?>" class="res-btn"><center>Book Now</center></a>
                  </div>
                </div>
              </div>
            </div>
           <div class="single-sidebar-widget-outer">
              ...
              <div class="popular-post">
                <ul>
                    ...
                    $query_p_2 = mysqli_query($connection,"SELECT * FROM `package_tbl` WHERE `package_type`='{$data_p["package_type"]}' and `package_id`!='{$id}'");
                    $count_2=mysqli_num_rows($query_p_2);
                    if($count_2>0)
                    {
                    while($data_p_2 = mysqli_fetch_array($query_p_2))
                    {
                    ?>
                  <li class="img-cap-effect">
                      <div class="img-box"><a href="package-detail.php?id=<?php echo $data_p_2["package_id"];?>"><img src="images/packages/<?php echo $data_p_2["package_imagepath"];?>" style="width:120px;height:100px;" alt=""></a></div>
                    <div class="content"><a href="package-detail.php?id=<?php echo $data_p_2["package_id"];?>">
                        <h4><?php echo $data_p_2["package_title"];?></h4></a>
                      <h6>₹<?php echo $data_p_2["package_price"];?></h6>
                    </div>
                  </li>  
            ...
            <div class="room-slider-wrapper">
              <div class="single-r-wrapper">
                <div class="single-sl-room">
                    <div data-hash="zero" class="owl-itemm"><img src="images/packages/<?php echo $data_p["package_imagepath"];?>" alt=""></div>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $data_p["package_title"];?></td>
                    </tr>
                    <tr>
                      <th scope="row"><code>Type : </code></th>
                      <td><?php echo $data_p["package_type"];?></td>
                    </tr>
                    <tr>
                      <th scope="row"><code>Price :</code></th>
                      <td>₹<?php echo $data_p["package_price"];?></td>
                    </tr>
                    <tr>
                        <?php 
                        $query_cat = mysqli_query($connection,"SELECT * FROM `category_tbl` where category_id='{$data_p["category_id"]}'");
