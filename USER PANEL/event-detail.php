...
$query_event = mysqli_query($connection,"SELECT * FROM `event_tbl` WHERE `event_id`='{$id}'");
$count=mysqli_num_rows($query_event);
if($count==0)
{
...
<head>
 ...
 <body class="vh-100">
    ...
    <section class="row final-inner-header">
      <div class="container">
        <h2 class="this-title"><?php echo $data_event["event_title"];?></h2>
      </div>
    </section>
    <section class="row final-breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $data_event["event_title"];?></li>
        </ol>
      </div>
    </section>
    <!-- Header  Slider style-->
          ...
          <div class="single-sidebar-widget sroom-sidebar">
            ...
            <div class="book-r-form">
              <div class="room-price">
                <h6>starting from</h6>
                <p>₹<?php echo $data_event["event_price"];?></p>
              </div>
              <div class="book-form">
                <div class="col-md-12">
                    <!--<b>Arrival Date</b>-->
...
<!--                <div class="col-md-12"><b>Adults</b>
                ...
                <div class="col-md-12">
                  ...
                  <a href="event-booking.php?id=<?php echo $data_event["event_id"];?>" class="res-btn"><center>Book Now</center></a>
                  </div>
                </div>
              </div>
            </div>
           <div class="single-sidebar-widget-outer">
              ...
              <div class="popular-post">
                <ul>
                    ...
                    $query_event_2 = mysqli_query($connection,"SELECT * FROM `event_tbl` WHERE `event_type`='{$data_event["event_type"]}' and `event_id`!='{$data_event["event_id"]}'");
                    while($data_event_2 = mysqli_fetch_array($query_event_2))
                    {
                    ?>
                  <li class="img-cap-effect">
                      <div class="img-box"><a href="event-detail.php?id=<?php echo $data_event_2["event_id"];?>"><img src="images/event/<?php echo $data_event_2["event_imagepath"];?>" style="width:120px;height:100px;" alt=""></a></div>
                    <div class="content"><a href="event-detail.php?id=<?php echo $data_event_2["event_id"];?>">
                        <h4><?php echo $data_event_2["event_title"];?></h4></a>
                      <h6>₹<?php echo $data_event_2["event_price"];?></h6>
                    </div>
                  </li>  
                    <?php } ?>
            ...
            <div class="room-slider-wrapper">
              <div class="single-r-wrapper">
                <div class="single-sl-room">
                    <div data-hash="zero" class="owl-itemm"><img src="images/event/<?php echo $data_event["event_imagepath"];?>" alt=""></div>
...
<!--                  <div data-hash="one" class="owl-itemm"><img src="images/rooms/gallery/1.jpg" alt=""></div>
            ...
            <div class="room-dec-wrapper">
              ...
              <p><?php echo $data_event["event_details"];?></p>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $data_event["event_type"];?></td>
                    </tr>
                    <tr>
                      <th scope="row"><code>Price :</code></th>
                      <td>₹<?php echo $data_event["event_price"];?></td>
                    </tr>
                    <tr>
                        <?php 
                        $query_cat = mysqli_query($connection,"SELECT * FROM `category_tbl` where category_id='{$data_event["category_id"]}'");
