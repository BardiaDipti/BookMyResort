      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 pull-left">
          <div class="book-left-content input_form">
              <form id="contactBooking" action="room-booking.php" method="post">
              <div class="row">
                  <input type="hidden" name="room_id" value="<?php echo $data_room["room_id"];?>">
                   <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                         <input id="name" type="text" name="booking_name" value="<?php echo $data_room["room_title"];?>"  placeholder="Enter Room Name" class="form-control" required readonly="">
                </div> 
                     <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                    <input id="name" type="text" name="book_amount" value="<?php echo $data_room["room_price"];?>"  placeholder="Enter Room Price" class="form-control" required readonly="">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
